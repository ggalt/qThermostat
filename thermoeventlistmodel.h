...
////////////////////////////////////////////////////////////////////////////////////////////////
/// \brief The thermoEventDelegate class
///

class thermoEventDelegate : public QStyledItemDelegate
{
    Q_OBJECT

public:
    thermoEventDelegate(QListView *v, QWidget *parent = 0) : QStyledItemDelegate(parent) { view = v;}
